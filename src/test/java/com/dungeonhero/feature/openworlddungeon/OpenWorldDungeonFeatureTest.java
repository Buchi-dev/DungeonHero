...
class OpenWorldDungeonFeatureTest {
  ...
  void completesConfiguredObjectiveAndRunsRewardOnce() {
    ...
    framework
        ...
        .register(
            new GameplayReward() {
              ...
              @Override
              public RewardResult grant(
                  com.dungeonhero.framework.context.GameplayContext context,
    ...
    config.set(
        "open-world-dungeon.Objectives",
        java.util.List.of(
            Map.of("Id", "zombies", "Type", "defeat_mobs", "Mob", "ZOMBIE", "Amount", 2)));
    config.set(
        "open-world-dungeon.Rewards",
        java.util.List.of(Map.of("Id", "reward", "Type", "test-reward")));
    ...
    assertEquals(
        ...
        framework
            .states()
            .getInt(OpenWorldDungeonFeature.ID + ":" + player, "objective.zombies.progress", 0));
