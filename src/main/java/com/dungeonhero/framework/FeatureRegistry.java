...
public final class FeatureRegistry {
    ...
    public synchronized void reload(ConfigurationSection featureRoot) {
        ...
        for (Map.Entry<String, GameplayFeature> entry : features.entrySet()) {
            ...
            ConfigurationSection section = featureRoot == null ? null : featureRoot.getConfigurationSection(id);
            ...
            try {
                ...
                errors.put(id, exception.getMessage() == null ? exception.getClass().getSimpleName() : exception.getMessage());
                lifecycles.put(id, FeatureLifecycle.FAILED);
        ...
        for (Map.Entry<String, GameplayFeature> entry : features.entrySet()) {
            ...
            try {
                ...
                errors.put(entry.getKey(), exception.getMessage() == null ? exception.getClass().getSimpleName() : exception.getMessage());
        ...
        for (Map.Entry<String, GameplayFeature> entry : features.entrySet()) {
            ...
            if (lifecycle == FeatureLifecycle.STARTED || lifecycle == FeatureLifecycle.LOADED) {
                try {
                    ...
                    context.warn("Feature '" + entry.getKey() + "' failed to stop: " + exception.getMessage());
                }
            }
            context.clearFeature(entry.getKey());
