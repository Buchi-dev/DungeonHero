...
/** Pure fragment-cap and overflow rules. */
public final class FragmentCapPolicy {
  ...
  public FragmentCapPolicy(double[] configuredCaps, double maximumStoredDamage) {
    ...
    this.maximumStoredDamage =
        Math.max(280, Double.isFinite(maximumStoredDamage) ? maximumStoredDamage : 100000);
  }

  public static FragmentCapPolicy defaults() {
    return new FragmentCapPolicy(null, 100000);
  }
  ...
  public double maximumStoredDamage() {
    return maximumStoredDamage;
  }
